...
| Инструмент            | URL                                                    | Доступ       |
|-----------------------|--------------------------------------------------------|--------------|
| Loki                  | Не доступен за пределами кластера                      | Не доступен за пределами кластера|
| Tempo                 | Не доступен за пределами кластера                      | Не доступен за пределами кластера|
| Prometheus            | http://hse-coursework-health.ru/prometheus             | Публичный|

> Если какой-то из опубликованных сервисов не открывается, пожалуйста, напишите автору в Telegram: [@igmalysh](https://t.me/igmalysh)
...
В дополнение к базовому мониторингу сервисов через Grafana и Prometheus, реализован:

- **Мониторинг бизнес-метрик**  
  Отслеживаются ключевые показатели (количество активных пользователей, сессии, конверсия входов, загрузка данных), чтобы оперативно реагировать на отклонения и принимать решения на основе актуальных данных.
...
- **Мониторинг инфраструктуры**  
  Слежение за состоянием кластера Kubernetes, нагрузкой CPU/RAM, задержками запросов и здоровьем компонентов (Kafka, Redis, базы данных).
